...
class ERA5Dataset(Dataset):
    ...
    def __init__(
        self,
        data_path: str = "data/uvtheta122",  # or "data/uvtp122", or "data/uvtp14"
    ...
    def __getitem__(self, index: int = 0) -> dict[str, torch.Tensor]:
        ...
        """
        # if len(self.ds.idim) == 369:  # 122 levels, inputfeatures_u_v_theta_*.nc
        #     batch = get_era5_uvtheta122(ds=self.ds, index=index)
        # elif len(self.ds.idim) == 72:  # 14 levels, era5_uvtp_uw_vw_uv_*.nc
        #     batch = get_era5_uvtp14(ds=self.ds, index=index)
